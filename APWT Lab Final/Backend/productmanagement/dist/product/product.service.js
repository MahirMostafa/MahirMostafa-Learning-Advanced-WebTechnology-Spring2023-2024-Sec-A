...
let ProductService = class ProductService {
    ...
    async create(createProductDto) {
        ...
        if (existingProduct) {
            throw new common_2.HttpException('Product already exists', common_2.HttpStatus.BAD_REQUEST);
        }
    ...
    async findOne(id) {
        ...
        if (!product) {
            throw new common_2.HttpException('Product not found', common_2.HttpStatus.NOT_FOUND);
        }
        return product;
    }
